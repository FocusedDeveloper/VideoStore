...
public:
   ...
   bool operator!=(const linkedListIterator<Type>& right) const;
     ...
     //               false.
    Type& getElementRef() const;
    // return a reference to the object at current
...
template <class Type>
Type& linkedListIterator<Type>::getElementRef() const
{
    return current->info;
}
...
template <class Type>
nodeType<Type> *linkedListType<Type>::GetFirst() const
{
    return first;
}
